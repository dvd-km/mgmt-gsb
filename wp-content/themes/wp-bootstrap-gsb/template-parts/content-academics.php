	...
	<div class="grid">
			...
			<div class="grid-4 bg-green yellow-light" id="hero_copy">
				...
				<ul class="nav navbar-nav">
					...
					if( $academics_21 ): 	
					?>
						<li class="menu-item"><a href="#academics_21"><?php echo $academics_21['academics_21_title']; ?></a></li>
						<li class="menu-item"><a href="#academics_22"><?php echo $academics_22['academics_22_title']; ?></a></li>
						<li class="menu-item"><a href="#academics_31"><?php echo $academics_31['academics_31_title']; ?></a></li>
						<li class="menu-item"><a href="#academics_32"><?php echo $academics_32['academics_32_title']; ?></a></li>
						<li class="menu-item"><a href="#academics_42"><?php echo $academics_42['academics_42_title']; ?></a></li>
		...
		<!--4. academics_details -->
			...
			if( $academics_21 ): 	
			?>
				<span class="anchor" id="academics_21"></span>
		...
		<?php $academics_22 = get_field('academics_22'); 
			if( $academics_22 ): 	
			?>	
				<div class="grid-8 bg-yellow-light blue" style="grid-row-end: span 3;">
					<span class="anchor" id="academics_22"></span>
			...
			<?php $academics_31 = get_field('academics_31'); 
				if( $academics_31 ): 	
				?>
					<div class="grid-4 grid-square bg-green yellow-light">
					<span class="anchor" id="academics_31"></span>
				...
				if( $academics_32 ): 	
				?>
					<div class="grid-4 grid-square bg-blue yellow-light">
						<span class="anchor" id="academics_32"></span>
				...
				if( $academics_42 ): 	
				?>
					<div class="grid-8 grid-square  bg-yellow-light red">
						<span class="anchor" id="academics_42"></span>
