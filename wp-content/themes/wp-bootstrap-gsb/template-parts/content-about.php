	...
	<div class="grid">
		...
		<div class="grid-4 bg-yellow-light red" id="hero_copy">
			...
			<ul class="nav navbar-nav">
				...
				if( $about_22 ): 	
				?>
					<li class="menu-item"><a href="#about_22"><?php echo $about_22['about_22_title']; ?></a></li>
					<li class="menu-item"><a href="#about_31"><?php echo $about_31['about_31_title']; ?></a></li>
					<li class="menu-item"><a href="#about_40"><?php echo $about_40['about_40_title']; ?></a></li>
					<li class="menu-item"><a href="#about_51"><?php echo $about_51['about_51_title']; ?></a></li>
					<li class="menu-item"><a href="#about_62"><?php echo $about_62['about_62_title']; ?></a></li>
					<li class="menu-item"><a href="#about_63"><?php echo $about_63['about_63_title']; ?></a></li>
					<li class="menu-item"><a href="#about_72"><?php echo $about_72['about_72_title']; ?></a></li>
					<li class="menu-item"><a href="#about_82"><?php echo $about_82['about_82_title']; ?></a></li>
		...
		?>
			...
			<div class="grid-8 bg-red yellow-light" style="grid-row-end: span 2;">
			<span class="anchor"  id="about_22"></span>
					...
					<p><?php echo $about_22['about_22_copy']; ?></p>
						...
						<div class="repeater serif"><!--about_block_3_repeater -->
		...
		if( $about_31 ): 	
		?>
			<div class="grid-4 bg-blue yellow-light">
				<span class="anchor" id="about_31"></span>
		...
		<?php $about_40 = get_field('about_40'); 
			if( $about_40 ): 	
			?>
			<div class="grid-12 bg-yellow-light blue row-span-2">
			<span class="anchor"  id="about_40"></span>
				...
				<div class="w-100 col-mobile-2">
					<div class="col-6 blue">
						...
						<div class="repeater serif"><!--offering_1_repeater -->
		...
		?>
			<div class="grid-4 bg-blue yellow-light">
				<span class="anchor" id="about_51"></span>
		...
		?>
			<div class="grid-4 bg-yellow-light blue">
				<span class="anchor" id="about_62"></span>
		...
		if( $about_63 ): 	
		?>
			<div class="grid-4 bg-green yellow-light">
				<span class="anchor" id="about_63"></span>
		...
		if( $about_72 ): 	
		?>
			<div class="grid-8 bg-red yellow-light grid-img-inline-multiple">
				<span class="anchor" id="about_72"></span>
		...
		if( $about_82 ): 	
		?>
			<div class="grid-4 bg-yellow-light blue serif">
				<span class="anchor" id="about_82"></span>
